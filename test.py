...
class ToolTests(unittest.TestCase):
    ...
    def test_genetic_algirithm(self):
        ...
        genetic=Genetic()
        genetic.number_of_papulation=16
        ...
        for item in genetic.main():
           val_list.append(map_binary_value_to_domain(bin_num=item.get_chromosome_value(),domain_max=max(domain),domain_min=min(domain),bin_size=genetic.genes_num))
